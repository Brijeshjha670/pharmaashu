  ...
  return (
    <Wrapper>
      ...
      >
        ...
        <SwiperSlide><CardStyle2 img={"/img/product5.png"}/></SwiperSlide>
        <SwiperSlide><CardStyle2 img={"/img/product6.png"}/></SwiperSlide>
        <SwiperSlide><CardStyle2 img={"/img/product7.png"}/></SwiperSlide>
